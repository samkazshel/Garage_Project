...
public class Van extends Vehicle{
	...
	public Van(String model, String regPlate, boolean mOT, String engineSize, float storageSpace, boolean roofRack) {
	...
	public String toString() {
		return "Van [storageSpace=" + storageSpace + ", roofRack=" + roofRack + ", model=" + model + ", regPlate="
